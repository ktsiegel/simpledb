...
*    src/simpledb/HeapPage.java 
  ...
  You will also need to implement an Iterator over the tuples in the
  page, which may involve an auxiliary class or data structure.  
...
<div class="exercise"><a name="ss">**Exercise 6.**</a>

...
public class BPlusTreePageIdTest extends SimpleDbTestBase {

	private BPlusTreePageId rootPtrId;
	private BPlusTreePageId internalId;
	private BPlusTreePageId leafId;
	private BPlusTreePageId headerId;

	@Before public void createPid() {
		rootPtrId = new BPlusTreePageId(1, 0, BPlusTreePageId.ROOT_PTR);
		internalId = new BPlusTreePageId(1, 1, BPlusTreePageId.INTERNAL);
		leafId = new BPlusTreePageId(1, 2, BPlusTreePageId.LEAF);
		headerId = new BPlusTreePageId(1, 3, BPlusTreePageId.HEADER);
	}

	/**
	 * Unit test for BPlusTreePageId.getTableId()
	 */
	...
	/**
	 * Unit test for BPlusTreePageId.pageno()
	 */
	...
	/**
	 * Unit test for BPlusTreePageId.hashCode()
	 */
	...
	/**
	 * Unit test for BPlusTreePageId.equals()
	 */
	@Test public void equals() {
		BPlusTreePageId pid1 = new BPlusTreePageId(1, 1, BPlusTreePageId.LEAF);
		BPlusTreePageId pid1Copy = new BPlusTreePageId(1, 1, BPlusTreePageId.LEAF);
		BPlusTreePageId pid2 = new BPlusTreePageId(2, 2, BPlusTreePageId.LEAF);
		BPlusTreePageId pid3 = new BPlusTreePageId(1, 1, BPlusTreePageId.INTERNAL);
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(BPlusTreePageIdTest.class);
	}
}

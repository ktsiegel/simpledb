 ...
 */
public class BPlusTreeScan implements DbIterator {
	 ...
	 *            in sorted order
	 */
	public BPlusTreeScan(TransactionId tid, int tableid, String tableAlias, IndexPredicate ipred) {
		this.tid = tid;
		this.ipred = ipred;
	...
	public void reset(int tableid, String tableAlias) {
		...
		if(ipred == null) {
			...
			this.it = ((BPlusTreeFile) Database.getCatalog().getDatabaseFile(tableid)).indexIterator(tid, ipred);
		}
	...
	public BPlusTreeScan(TransactionId tid, int tableid, IndexPredicate ipred) {
	 ...
	 * name.
	 * 
	 * @return the TupleDesc with field names from the underlying BPlusTreeFile,
